...
@section('title', 'Canceled-Booking')
...
@section('content')
            ...
            <div class="flex-1 p-8">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-3xl font-bold">Canceled Booking</h1>
                </div>
    ...
    <!-- Tabel untuk data Canceled Booking -->
    <table class="w-full table-auto bg-white shadow-md rounded-lg">
        ...
        <tbody>
            <tr class="border-t">
                <td class="p-4">1</td>
                <td class="p-4">EXSEA123451</td>
                <td class="p-4">20/08/2024</td>
                <td class="p-4 text-red-500">Canceled</td>
                <td class="p-4">FCL Export</td>
                <td class="p-4">Jakarta, Indonesia</td>
                <td class="p-4"><button class="text-blue-500">Restore</button></td>
            </tr>
