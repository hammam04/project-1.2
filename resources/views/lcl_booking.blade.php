...
@section('title', 'lcl-booking')

@section('content')
<div class="container mx-auto px-4">
    <!-- Page Title -->
    <div class="flex justify-between items-center py-6">
        <h1 class="text-2xl font-bold">LCL Booking</h1>
    </div>
    ...
    <div class="flex flex-col space-y-4 mb-6">
        ...
        <div class="flex space-x-4 items-center">
            ...
            <button class="bg-blue-100 text-blue-500 px-4 py-2 rounded-md hover:bg-blue-200">LCL Export</button>
            <button class="bg-green-100 text-green-500 px-4 py-2 rounded-md hover:bg-green-200">LCL Local</button>
        </div>
        ...
        <table class="min-w-full bg-white">
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-100 transition duration-200">
                    ...
                    <td class="py-3 px-4">
                        <span class="bg-green-500 text-white px-3 py-1 rounded-full">Local LCL</span>
                    </td>
                    <td class="py-3 px-4">Surabaya, Indonesia</td>
                    <td class="py-3 px-4">
